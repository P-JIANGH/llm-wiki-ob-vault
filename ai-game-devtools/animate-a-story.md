...
| [[ai-game-devtools/talecrafter]] | 故事→布局→图像→视频四模块管线，多角色 | 学术研究 |
| [[ai-game-devtools/animatediff]] | 图像动画扩散 motion module，无需检索 | Apache 2.0 |
| [[ai-game-devtools/animate-anyone]] | 单图+姿态→一致性动画，角色换装/说话头像 | Apache 2.0 |
