...
- 相比 [[ai-game-devtools/musicgen]]（Meta 单阶段自回归），AudioX 采用扩散模型 + 多模态融合，支持视频/音频联合条件输入
- 相比 [[ai-game-devtools/audioldm-2]]（仅文本条件），AudioX 统一了文本/视频/音频三种条件模态
- 相比 [[ai-game-devtools/amphion]]（综合音频工具箱），AudioX 专注于统一的多模态条件生成框架
