...
- 相比 [[imagebind]]：BriVL 专注中文图文检索（双模态），ImageBind 覆盖 6 种模态但非中文优化
- 相比 [[qwen-vl]]：BriVL 为纯对比学习检索模型，Qwen-VL 为端到端生成式 VLM
- 相比 [[minigpt-4]]：BriVL 为检索/特征提取专用，MiniGPT-4 为视觉问答+生成
- 相比 [[sharegpt4v]]：BriVL 面向中文场景，ShareGPT4V 面向英文通用场景
