...
- 渲染器基于 [[syncdreamer]] 同类 3D 高斯管线
- 与 [[neuralangelo]] 同属 3D 重建工具，但 CF-3DGS 使用高斯而非 SDF-NeRF
- 可与 [[video2game]] 管线结合（后者需要 COLMAP 预处理，CF-3DGS 可替代该步骤）
- 和 [[anything-3d]] 均解决单视图到 3D 问题，但 CF-3DGS 面向多视图序列重建
