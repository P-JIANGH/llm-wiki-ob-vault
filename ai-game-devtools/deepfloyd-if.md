...
- 与 [[ai-game-devtools/comfyui]] 不同：DeepFloyd IF 是**端到端级联模型**，而 ComfyUI 是**模块化扩散管线编排引擎**
- 与 [[ai-game-devtools/controlnet]] 不同：ControlNet 提供**条件控制**，IF 是**完整的文本到图像生成系统**
- 与 [[ai-game-devtools/flux]] 类似：两者都是级联/多阶段扩散架构，FLUX 由 Black Forest Labs 开发
