...
| **GLM-4-Voice-9B** | 核心对话模型 | 基于 [[ai-game-devtools/glm-4]] GLM-4-9B 预训练，语音模态对齐 |
| **GLM-4-Voice-Decoder** | 语音解码器 | 基于 [[ai-game-devtools/cosyvoice]] CosyVoice 重训练 Flow Matching 模型，10 token 即可开始推理 |
