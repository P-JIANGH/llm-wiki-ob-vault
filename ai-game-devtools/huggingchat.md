...
HuggingChat 是 Hugging Face 官方的开源 LLM 聊天界面产品，通过开源仓库 `huggingface/chat-ui` 提供源码。它是一个 [[SvelteKit]] 2 应用，通过 OpenAI 兼容 API 与任意 LLM 后端通信，驱动着 [hf.co/chat](https://huggingface.co/chat) 上的 HuggingChat 产品。相比 [[ai-game-devtools/dify]] 等国内平台，HuggingChat 更轻量，专注聊天界面而非工作流编排。
...
| 特性 | HuggingChat | [[ai-game-devtools/dify]] | [[ai-game-devtools/text-generation-webui]] |
|------|-------------|---------------------------|-------------------------------------------|
...
- 游戏 NPC 对话后端 — 通过 OpenAI 兼容 API 与 [[ai-game-devtools/cradle]] 或 [[ai-game-devtools/larp]] 等 Agent 框架集成
