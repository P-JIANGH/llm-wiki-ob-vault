...
与 [[motionllm]]（视频+动作联合理解）不同，HY-Motion 1.0 专注于**从零生成** 3D 动作而非理解已有视频。与 [[hunyuanvideo-avatar]]（视频驱动角色动画）相比，HY-Motion 1.0 采用文本驱动、全身骨骼生成范式，适用于游戏角色动画管线中的动作生成环节，而非面部表情或肖像动画。
