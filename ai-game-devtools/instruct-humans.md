...
- 与 [[dreammat]] 同属 3D 纹理生成领域，但 DreamMat 专注于 PBR 材质生成，而 InstructHumans 专注于人类角色纹理的指令编辑
- 与 [[dream-textures]] 同为纹理编辑工具，但 Dream Textures 面向 Blender 无缝贴图，InstructHumans 面向 3D 角色动画纹理
- 与 [[crm]] 同属 3D 生成管线，但 CRM 从单图生成完整 3D 网格，InstructHumans 编辑已有 3D 角色的纹理
