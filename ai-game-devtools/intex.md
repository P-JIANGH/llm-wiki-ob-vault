...
| 维度 | InteX | [[dreammat]] | [[dream-textures]] |
|------|-------|------|------|
...
- [[dreammat]] — SIGGRAPH 2024 PBR 材质生成（几何/光照感知扩散模型）
- [[dream-textures]] — Blender Stable Diffusion 纹理绘制集成
- [[crm]] — 单图到 3D 纹理网格的两阶段扩散方法
- [[syncdreamer]] — 多视角一致 3D 生成，可为纹理提供参考视图
