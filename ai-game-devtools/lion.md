...
## 与同类工具对比
- 类似 [[gaussiandreamer]]：都用扩散模型生成 3D，但 LION 用点云表示，GaussianDreamer 用 3D 高斯溅射
- 类似 [[stable-diffusion]]：LION 是"3D 版潜在扩散"——将 SD 的 latent diffusion 思想迁移到点云空间
- 相比 [[hunyuan3d-2-1]]：LION 是 2022 年早期工作，Hunyuan3D 2.1 是腾讯 2024/2025 年更完整的 3D 生成管线
- 与 [[cosmos]] 同属 NVIDIA 生成式 AI 家族，但 Cosmos 专注世界模型，LION 专注 3D 几何
