...
- 相比 [[flux]]（Black Forest Labs），Lumina-Image 2.0 使用 FLUX VAE 但自有 DiT 架构
- 相比 [[stable-diffusion]]，Lumina 2.0 采用 DiT 而非 U-Net，推理效率更高
- 相比 [[comfyui]]（运行平台），Lumina 2.0 是具体模型，已被 ComfyUI 原生支持
- 与 [[lumina-t2x]]、[[lumina-dimoo]] 同属 Alpha-VLLM 的 Lumina 系列
