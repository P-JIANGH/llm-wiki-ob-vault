...
- **音频 VAE**: 1D VAE（源自 [[make-an-audio-3]] 的 BigVGAN 声码器）
...
- vs [[audioldm-2]]: AudioLDM 2 使用标准扩散，MeanAudio 用 MeanFlow 实现单步生成
- vs [[amphion]]: Amphion 是综合音频工具包（TTS/VC/SVC），MeanAudio 专注 T2A 生成
- vs [[audiogen-codec]]: AudioGen Codec 仅做编解码，MeanAudio 是完整生成模型
