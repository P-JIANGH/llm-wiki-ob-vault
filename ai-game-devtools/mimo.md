...
- 与 [[ai-game-devtools/animate-anyone]] 同属阿里系扩散模型角色动画方案，但 MIMO 增加了场景分解和交互支持
- 与 [[ai-game-devtools/animatediff]] 相比：AnimateDiff 是基于 SD 的通用动画模块，MIMO 专注角色视频生成且支持属性解耦
- 与 [[ai-game-devtools/liveportrait]] 相比：LivePortrait 专注头像面部动画，MIMO 覆盖全身 + 场景交互
