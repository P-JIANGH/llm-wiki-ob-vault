...
1. **MindSearchAgent（规划器）** — 主 Agent，基于 [[ai-game-devtools/internlm]] 的 Lagent 框架构建，负责将用户查询分解为子问题图
...
- 相比 [[ai-game-devtools/perplexica]] 等传统 RAG 搜索，MindSearch 采用动态图分解而非静态检索
- 与 [[ai-game-devtools/open-deep-research]] 类似但更注重搜索过程的可视化和流式展示
- 基于 [[ai-game-devtools/internlm]] 生态，与 [[ai-game-devtools/cradle]] 共享 Lagent Agent 框架基础
