...
| 组件 | 技术 |
|:---|:---|
| **LLM 基座** | [[ai-game-devtools/qwen2]]（Qwen2） |
...
| **合成语音数据** | [[ai-game-devtools/cosyvoice]]（CosyVoice） |
| **对齐数据** | OpenOrca + MOSS |
...
- **语言**：Python
- **GitHub Stars**：3.5k
- **相关页面**：[[ai-game-devtools/llasm]]（语音-文本多模态对话模型）、[[ai-game-devtools/qwen2-audio]]（Qwen 音频模型）
