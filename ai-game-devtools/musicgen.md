...
- **NPC 对话配乐**: 与 [[ai-game-devtools/wavjourney]] 管线集成，构建完整音频叙事
- **音效补充**: 与 [[ai-game-devtools/audiogen-codec|AudioGen]] 配合，覆盖音乐+音效全场景

## Related Projects

- [[ai-game-devtools/audiocraft]] — AudioCraft PyTorch 库（MusicGen 所在框架）
- [[ai-game-devtools/jukebox]] — OpenAI 先驱性自回归音乐生成，3级VQ-VAE+分层Transformer
- [[ai-game-devtools/magenta]] — Google Brain AI 艺术/音乐生成研究项目
- [[ai-game-devtools/wavjourney]] — LLM 驱动的组合式音频创作管线（使用 MusicGen 作为音乐组件）
- [[ai-game-devtools/flux-music]] — Rectified Flow 架构音乐生成，对比 MusicGen 的 AR 方案
