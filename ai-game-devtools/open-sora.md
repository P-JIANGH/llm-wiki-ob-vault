...
- 人类偏好与 [[hunyuan-video]] 11B、Step-Video 30B 相当
- 训练成本仅 ~$200K
...
- 相比 [[hunyuan-video]]：Open-Sora 强调训练成本效率（$200K vs 腾讯未公开），开源更完整（含训练代码）
- 相比 [[cogvideox]]：CogVideoX 专注 T2V+I2V 双模直接输出，Open-Sora 推荐 T2I2V 间接管线质量更优
- 相比 [[mochi-1]]：Open-Sora 11B 参数量相近，但训练成本透明公开
- 相比 [[stable-video-diffusion]]：Open-Sora 2.0 质量远超早期 SD Video，支持 768p 高分辨率
