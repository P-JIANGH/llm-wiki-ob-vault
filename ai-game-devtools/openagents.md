...
与 [[ai-game-devtools/langchain]] 代码库兼容，强调实际应用场景而非概念验证。
...
## 相关项目
- 基于 [[ai-game-devtools/langchain]] 构建
- 与 [[ai-game-devtools/autogen]]、[[ai-game-devtools/dify]] 同属 Agent 平台类工具
- XLang Lab 同期发布 [[ai-game-devtools/lemur]]（语言 Agent 基础模型）
