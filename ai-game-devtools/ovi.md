...
### Twin Backbone 双主干设计
- **视频分支**：基于 [[ai-game-devtools/wan2-2]] 初始化，使用 Wan VAE 2.2 编解码
...
- [[ai-game-devtools/hunyuan-video]] — 腾讯混元视频生成模型，同属 DiT 架构视频生成
- [[ai-game-devtools/cogvideox]] — 智谱 AI 开源视频生成模型
- [[ai-game-devtools/mochi-1]] — Genmo 10B 参数文本到视频扩散模型
