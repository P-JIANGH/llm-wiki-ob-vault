...
## Overview
Stability AI 官方 SD3.5/SD3 推理参考实现。专注于提供简洁的推理管线，不含训练代码。推荐一般用户使用 [[comfyui]] 进行推理。
...
## 与同类工具差异
- **极简设计**：仅推理参考，无训练/微调能力，代码量远小于 [[comfyui]] 和 [[stable-diffusion-webui]]
- **推荐搭配 ComfyUI**：官方明确推荐 ComfyUI 作为生产推理 UI，本仓库仅作为参考实现
- **SD3/SD3.5 架构统一**：MM-DiT 架构与前代 UNet 扩散（如 [[stable-diffusion]]）完全不同
