...
StableVideo 是 ICCV 2023 发表的文本驱动一致性视频编辑工具，基于 [[ai-game-devtools/controlnet]] 扩散模型和 Text2LIVE 的神经分层图集（NLA）技术，实现对视频中特定区域的文本控制编辑，同时保持帧间时间和空间一致性。

## 核心架构

- **基础**: 在 [[ai-game-devtools/stable-diffusion]] SD1.5 + ControlNet 之上扩展，添加 NLA 分解和 AGGNet 聚合网络
...
- 相比 [[ai-game-devtools/controlnet]]: ControlNet 仅支持单图条件生成；StableVideo 扩展到视频，通过 NLA 分解实现时序一致编辑
- 相比 [[ai-game-devtools/stable-diffusion]]: SD 是纯图像生成；StableVideo 添加视频分解管线，支持区域级视频编辑
