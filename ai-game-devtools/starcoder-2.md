...
**StarCoder2** 是 BigCode 项目（Hugging Face + ServiceNow）推出的第二代代码生成模型家族，包含 3B、7B、15B 三种规模，基于 600+ 编程语言和自然语言文本训练，是 [[ai-game-devtools/starcoder]] 的全面升级版。
...
- 配合 [[ai-game-devtools/codegeex2]]、[[ai-game-devtools/codegeex4]] 等形成代码模型选型矩阵
- 与 [[ai-game-devtools/deepseek-coder]] 同属开源代码生成模型竞品
