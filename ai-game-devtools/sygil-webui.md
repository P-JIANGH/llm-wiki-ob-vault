...
Sygil-Dev 团队开发的 Stable Diffusion 浏览器端 Web UI（2022年），是早期 SD Web 界面之一，与 [[stable-diffusion-webui]]（AUTOMATIC1111）并行开发。提供文生图、图生图、文生视频功能，通过浏览器操作。
...
与 [[stable-diffusion-webui]]（AUTOMATIC1111）和 [[comfyui]] 相比：
