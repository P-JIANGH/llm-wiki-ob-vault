...
- 与 [[stable-diffusion]] 不同：SD 是图像生成模型，Text2Video-Zero 将其扩展为视频生成，无需额外训练
- 与 [[controlnet]] 互补：Text2Video-Zero 内置了 ControlNet 的 pose/edge/depth 条件控制能力，但核心贡献是零样本视频一致性技术
