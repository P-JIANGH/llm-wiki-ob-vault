...
- [[ai-game-devtools/stable-dreamfusion]]：同一作者（Jiaxiang Tang）的 DreamFusion 早期实现，threestudio 是其后续更完善的框架版本
- [[ai-game-devtools/gaussiandreamer]]：用 3DGS 替代 NeRF 的文本到 3D 生成，threestudio 支持 Gaussian Splatting 作为后端
- [[ai-game-devtools/mvdream]]：多视角扩散模型，threestudio 内置支持
- [[ai-game-devtools/dreamgaussian4d]]：4D 高斯生成，threestudio 扩展支持动态 3D 内容
