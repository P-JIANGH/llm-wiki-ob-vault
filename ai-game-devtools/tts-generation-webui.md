...
- [[ai-game-devtools/retrieval-based-voice-conversion-webui]] — RVC 语音转换，作为 TTS WebUI 的子工具集成
- [[ai-game-devtools/musicgen]] — Meta 音乐生成模型，作为 TTS WebUI 的音频生成模块
- [[ai-game-devtools/openvoice]] — MyShell 声音克隆，作为 TTS WebUI 扩展可用
- [[ai-game-devtools/cosyvoice]] — 阿里通义 CosyVoice TTS，作为 TTS WebUI 扩展可用
