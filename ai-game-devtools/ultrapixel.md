...
UltraPixel 是一个超高分辨率图像生成模型，NeurIPS 2024 发表论文。基于 [[ai-game-devtools/stable-cascade]] 和 Trans-inR 构建，能够生成细节丰富、质量极高的超高分辨率图像。支持文本到图像、个性化 LoRA 和 ControlNet 工作流。
...
- 与 [[ai-game-devtools/stable-diffusion]] 相比，UltraPixel 基于级联架构（StableCascade），通过中间 latent 空间压缩实现更高的分辨率和效率
- 与 [[ai-game-devtools/flux]] 相比，UltraPixel 专注于超高分辨率（4K+）合成，使用 tiled decoding 技术突破显存瓶颈
- 内置 [[ai-game-devtools/controlnet]] 兼容，支持边缘控制条件生成
