...
- 相比 [[ai-game-devtools/wan2-1]]：Wan2.2 引入 MoE 架构，训练数据量 +65.6% 图像/+83.2% 视频，新增 S2V 和 Animate 变体
- 相比 [[ai-game-devtools/hunyuan-video]]（腾讯混元 13B+）：Wan2.2 MoE 在相同计算量下提供更大容量，TI2V-5B 在消费级 GPU 上表现更优
- 相比 [[ai-game-devtools/cogvideox]]（智谱 2B/5B/12B）：Wan2.2 A14B 参数量更大但通过 MoE 保持推理效率，支持更多任务类型（T2V/I2V/S2V/Animate）
- 相比 [[ai-game-devtools/open-sora]]：Wan2.2 提供完整预训练权重，Open-Sora 为 Sora 架构复现项目
