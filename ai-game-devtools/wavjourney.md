...
- **TTM (Text-to-Music)**: [[ai-game-devtools/musicgen]] Facebook MusicGen，small/medium/large 三档
- **TTA (Text-to-Audio)**: Facebook AudioGen，medium 档，生成音效/环境声
- **TTS (Text-to-Speech)**: [[ai-game-devtools/bark]] Suno Bark + HuBERT 声纹克隆，支持预设音色库
...
- 相比单一音频生成工具（如 [[ai-game-devtools/musicgen]] 只生成音乐），WavJourney 是**组合式创作**——同时编排语音/音乐/音效多轨
