...
- 与 [[design2code]] 相比：Design2Code 是 screenshot-to-code 评测基准（学术方向），WebDesignAgent 是端到端的实用网站生成 Agent
- 与 [[demogpt]] 相比：DemoGPT 生成 Streamlit 应用框架，WebDesignAgent 生成完整的 Tailwind CSS 前端页面，支持模板参考和人机交互迭代
- 与 [[dify]] 相比：Dify 是 LLM 应用开发平台，WebDesignAgent 专注网页代码生成，是更垂直的工具
