...
- [claude-code-game-studios](#/entities/claude-code-game-studios) — Project overview
- [claude-code-game-studio-architecture](#/concepts/claude-code-game-studio-architecture) — Agent hierarchy, coordination rules, model tiers
