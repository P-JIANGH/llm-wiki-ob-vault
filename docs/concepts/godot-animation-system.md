...
## 相关
[godot-4](#/concepts/godot-4) — Godot 4 引擎概述
[gdscript-patterns](#/concepts/gdscript-patterns) — CharacterController 包含所有角色控制逻辑
[microverse-character-system](#/concepts/microverse-character-system) — 角色 SpriteFrames 在 .tscn 中的配置
