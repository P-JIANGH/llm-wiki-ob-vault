...
## Related
[microverse-code-structure](#/entities/microverse-code-structure) — ConversationManager 位于 script/ai/
[multi-agent-ai-game-impl](#/concepts/multi-agent-ai-game-impl) — 对话是 AI 决策的子模块
