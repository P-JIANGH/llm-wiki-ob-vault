...
使用 UDP Socket 实现 P2P 风格多人，与 [open-source-game/eduke32](#/open-source-game/eduke32) 的网络架构相似。
...
这是与 [open-source-game/eduke32](#/open-source-game/eduke32)（C++/原生）最大的架构差异——BuildGDX 通过 LibGDX 获得跨平台能力，而 EDuke32 通过 SDL2 手动抽象。
...
| **确定性游戏逻辑** | Build Engine 的游戏逻辑完全数据驱动（sprite/tag/sector），与 [open-source-game/quake](#/open-source-game/quake) 的模块化 game/cgame/server 分离思路一致 |
...
- [open-source-game/eduke32](#/open-source-game/eduke32) — 同为 Build Engine 端口，C++/SDL2 实现
...
- [open-source-game/duke-nukem-3d](#/open-source-game/duke-nukem-3d) — Duke Nukem 3D 原始源码
- [open-source-game/shadow-warrior](#/open-source-game/shadow-warrior) — Shadow Warrior 原始源码
