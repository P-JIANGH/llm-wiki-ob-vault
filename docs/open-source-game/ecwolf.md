...
- [open-source-game/wolfenstein-3d](#/open-source-game/wolfenstein-3d) — 原始 id Software Wolfenstein 3D 源码
- [open-source-game/chocolate-doom](#/open-source-game/chocolate-doom) — Doom Bug-Compatible 端口参考
- [open-source-game/uzdoom](#/open-source-game/uzdoom) — ZDoom 延续（ECWolf 兼容其 API 设计）
