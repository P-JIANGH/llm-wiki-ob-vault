...
| 关卡编辑器 | [open-source-game/egregoria](#/open-source-game/egregoria) 的协作规划理念类似，编辑器内嵌降低门槛 |
| AI 系统 | 敌人/NPC AI 分层设计（enemy.lisp + trigger.lisp + ai.lisp）可被 agent 理解和扩展 |
| 确定性物理 | BVH2 碰撞可作为 [open-source-game/fish-folk-jumpy](#/open-source-game/fish-folk-jumpy) rapier2d 物理之外的替代方案 |

## 相关页面

- [open-source-game/trial](#/) — TRIAL 游戏引擎（Kandria 的底层）
- [open-source-game/frogatto](#/open-source-game/frogatto) — 同样使用模块化引擎架构的游戏
