...
updated: 2026-04-09
type: concept
tags: [open-source, game, racing, simulation, drift, sdl3, bullet-physics]
sources: []
---
...
- [open-source-game/endless-sky](#/open-source-game/endless-sky) — 太空探索贸易，另一个开源模拟游戏
- [open-source-game/openra](#/open-source-game/openra) — 开源游戏复刻项目
