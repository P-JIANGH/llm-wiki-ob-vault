...
> Last updated: 2026-04-20 | Total pages: 745 | Note: Open Source Games section is partial (65/153 games indexed; all 153 games exist in open-source-game/ directory)
     6|
     7|## AI / LLM / Agent
     8|
...
|| [[ai-game-devtools/llm-unity-integration]] — LLM 集成 Unity 架构模式：本地 llama.cpp/云 API/混合三种部署方案，NPC 对话流式输出/行为树集成/任务生成/性能优化全指南 |
    ...
    89|| [[ai-game-devtools/aicommand]] — AI 命令行助手：自然语言→Shell 命令生成 + 命令解释 + 交互式终端对话，支持 OpenAI/本地模型，游戏开发构建/资产处理自动化 |
...
|| [[ai-game-devtools/backgroundremover]] — nadermx U2Net AI 抠图工具：CLI+HTTP API+Python 库+Docker 支持，图像/视频/批量/管道模式，Alpha 精细抠边，ProRes 4444 透明视频输出，GPU 加速 5-10x，MIT |
   ...
   219|||| [[ai-game-devtools/video-chatgpt]] — MBZUAI 视频对话模型（ACL 2024）：CLIP ViT-L/14 + Vicuna LLM + 100K 视频指令数据，MSVD-QA 64.9%/ActivityNet-QA 35.2% SOTA，CC BY-NC-SA 4.0
...
|| [[ai-game-devtools/wav2lip]] — IIIT Hyderabad ACM MM 2020 音频驱动唇形同步：U-Net 编码器-解码器 + SyncNet 专家判别器作为感知损失，LRS2 训练，支持任意身份/语言/CGI 面孔，非商用许可
   ...
   266|||| [[ai-game-devtools/sd-webui-mov2mov]] — Scholar01 stable-diffusion-webui 视频转视频插件：逐帧 img2img 处理+视频重打包，关键帧+Ebsynth 插值减少闪烁(beta/仅 Windows)，OpenCV+imageio 管线，MIT |
