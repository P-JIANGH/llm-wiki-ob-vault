...
- [[devilutionx]] — Diablo + Hellfire 清洁室逆向开源端口（对比：逆向 vs 清洁室）
- [[freeablo]] — Diablo 1 清洁室重实现，双线程架构（对比：并行项目）
- [[open-diablo-2]] — 本项目的"前身"，OpenDiablo2 的游戏逻辑层
- [[opennox]] — 同样是 Westwood 类游戏的清洁室重实现（参考设计哲学）
