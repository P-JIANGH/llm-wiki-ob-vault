...
- [[exult]] — Ultima VII 重实现，另一个经典 RPG 引擎重实现
- [[daggerfall-unity]] — Daggerfall Unity，另一款经典 RPG 引擎重实现
- [[openmw]] — Morrowind 引擎重实现，成熟度最高的开源 RPG 引擎之一
- [[veloren]] — Rust 体素 RPG，ECS 架构参考
