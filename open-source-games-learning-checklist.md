...
> 每 10 分钟学习一个项目（git clone → 快速分析 → 记录要点到 wiki）
> 学习完成后在 `[ ]` 中填入完成日期，格式：`[2026-04-08]`
> 源文件：raw/articles/open-source-games-list-2026.md
...
- [ ] **Frogatto & Friends** — 动作冒险平台跳跃 | `https://github.com/frogatto/frogatto`
...
- [ ] **SuperTuxKart** — 卡丁车派对游戏 | `https://github.com/supertuxkart/stk-code`
...
- [ ] **Dungeon Crawl Stone Soup** — 经典 Roguelike，地下城探索 | `https://github.com/crawl/crawl`
- [ ] **Cataclysm: Dark Days Ahead** — 后世界末日生存 | `https://github.com/CleverRaven/Cataclysm-DDA`
...
### Main RPGs
- [ ] **OpenMW** — Morrowind 引擎复刻（C++，最成熟开源 RPG 引擎之一） | `https://github.com/OpenMW/openmw`
...
- [ ] **Exult** — Ultima VII 复刻 | `https://github.com/exult/exult`
...
- [ ] **OpenNox** — Nox 引擎社区扩展 | `https://github.com/noxworld-dev/opennox`
...
### Diablo 系列
- [ ] **DevilutionX** — Diablo + Hellfire 端口 | `https://github.com/diasurgical/devilutionX`
- [ ] **Freeablo** — Diablo I 引擎重制 | `https://github.com/wheybags/freeablo`
- [ ] **Open Diablo II** — Diablo 2 开源复刻 | `https://github.com/OpenDiablo2/OpenDiablo2`
...
- [ ] **OpenKore** — Ragnarok Online 自动化助手 | `https://github.com/OpenKore/openkore`
...
- [ ] **Pooltool** — 台球物理沙盒 | `https://github.com/ekiefl/pooltool`
...
- [ ] **OpenRW** — GTA III 重实现 | `https://github.com/rwengine/openrw`
...
> 每完成一个项目，在上面 `[ ]` 填入日期
> Wiki 页面命名规范：`open-source-game/[项目名小写-连字符].md`
...
| 55 | 2026-04-09 | Sonic Robo Blast 2 | Doom Legacy 分支3D Sonic同人作；双渲染器架构(OpenGL硬件+SDL2软件)；252K LOC C (211 .c+180 .h)；Lua 5.1+DEHACKED扩展；TicCommand帧同步网络多人；Master Server支持；专用服务器模式；info.c单文件22K LOC游戏对象定义表 |
| 56 | 2026-04-09 | Rigel Engine | Duke Nukem II 清洁室逆向重实现（C++17/SDL2+OpenGL双渲染器，~45K LOC），模块化ECS架构（engine/游戏逻辑/渲染器/UI分离），读原始NUKEM2.CMP数据文件驱动，USE_GL_ES切换OpenGL/GLES2编译选项，ImGui调试UI，GPLv2 |
